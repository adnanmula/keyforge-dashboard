...
final class KeyforgeTagsFixtures extends DbalFixture implements Fixture
{
    ...
    public function load(): void
    {
        ...
        $this->save(new KeyforgeTagHasBRIG());
        $this->save(new KeyforgeTagHasBoardWipes());
        $this->save(new KeyforgeTagHasCollectorWorm());
        $this->save(new KeyforgeTagHasDoubleCards());
        $this->save(new KeyforgeTagHasDysania());
        $this->save(new KeyforgeTagHasFangtoothCavern());
        $this->save(new KeyforgeTagHasGenKa());
        $this->save(new KeyforgeTagHasHeartOfTheForest());
        ...
        $this->save(new KeyforgeTagHasOrtannu());
        ...
        $this->save(new KeyforgeTagOwnerChopi());
