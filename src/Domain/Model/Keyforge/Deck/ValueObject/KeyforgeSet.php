...
enum KeyforgeSet: string
{
    ...
    {
        return match ($this) {
            self::U22, self::VM23, self::VM24, self::VM25, self::VM26, self::M24, self::MARTIAN_CIVIL_WAR, self::ToC, self::MoM, self::DIS, self::CC => false,
            default => true,
        };
    }
